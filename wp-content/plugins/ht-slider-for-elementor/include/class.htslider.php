...
final class HTSlider_Addons_Elementor {
    ...
    */
    public function plugins_setting_links( $links ) {
        ...
        $links['htslider_pro'] = sprintf('<a href="https://codecanyon.net/item/ht-slider-pro-for-elementor/25509064?s_rank=2" target="_blank" style="color: #39b54a; font-weight: bold;">' . esc_html__('Go Pro','ht-slider') . '</a>');
        }
        return $links; 
    }
